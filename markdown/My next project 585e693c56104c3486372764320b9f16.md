...
- [x]  This video has … views
- [x]  Unlimited cloud storage using discord
- [x]  Fetch data from weather api, create video using remotion, upload to youtube
- [x]  24/7 stream using nodejs and tiktok
- [ ]  Tiktok clone with nextjs, next-auth, prisma, trpc
- [ ]  Endless tic tac toe map
- [ ]  Facebook clone with nextjs, nhost, hasura, nextauth
- [ ]  Chess with minimax algorithm
- [ ]  Ecommerce website using medusa
- [ ]  UI library like react
- [ ]  Self hosted platform as a service like firebase/supabase
- [ ]  Scratch clone
